...
class DictionaryPageState extends State<DictionaryPage> {
  ...
  Widget buildDictionaryList() {
    return GridView.count(
        ...
        padding: EdgeInsets.only(top: (1 / 19.2).sh, right: (1 / 54).sw),
        //遍历图鉴列表生成布局
    ...
    return Container(
      child: GestureDetector(
          ...
          child: Stack(children: [
            ...
            Padding(
                //词典名字
                padding: EdgeInsets.only(top: (1 / 60).sh, left: (1 / 9).sw),
                child: Text(
                  dictionaryName,
            ...
            Padding(
              //词典图标
              padding: EdgeInsets.only(top: (1 / 140).sh, left: (1 / 42).sw),
              child: Image.asset(
                'assets/词典/词典.png',
                width: (1 / 12.7).sw,
                height: (1 / 12.7).sw,
