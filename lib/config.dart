...
bool isNewImage = false; //AI图鉴开关
bool scrolling = true; //自动滚屏开关
String nowMikoAvater = "1"; //miko当前头像
...
//玩家头像
AssetImage playerhead = AssetImage('assets/icon/未知用户.png');
...
Map dictionaryMap = {
  ...
  '锦户亮': ['第二章', false, '日本演员，为人真实不做作，性格比较宅，对不感兴趣的东西可以一句话不说，但对熟悉的人却会撒娇和吐槽毒舌。'],
  '纽约重芝士蛋糕': ['第二章', false, 'NewYorkCheesecake，一种美式甜品，没有多余的辅料和装饰却拥有浓厚有丝滑的口感。'],
  '皮尔斯': [
    '第二章',
    false,
  ...
  '熵': ['第三章', false, '泛指某些物质系统状态的一种量度，某些物质系统状态可能出现的程度。亦被社会科学用以借喻人类社会某些状态的程度'],
  '门房': ['第三章', false, '门卫住的房间'],
  '波斯王子时之砂': [
    '第三章',
    false,
